...
namespace FluentSecurity
{
	public interface IPolicyContainer
	{
		...
		IPolicyContainer AddPolicy(ISecurityPolicy securityPolicy, Cache level);
		IPolicyContainer AddPolicy(ISecurityPolicy securityPolicy, CacheManifest cacheManifest);
